...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/caesar/ASM_CAESAR_noload.urdf";
  ...
  mecali::generate_code(fd, "ASM_CAESAR_noload_fd", codegen_options);
  mecali::generate_code(id, "ASM_CAESAR_noload_id", codegen_options);
  mecali::generate_code(M, "ASM_CAESAR_noload_M", codegen_options);
  mecali::generate_code(Minv, "ASM_CAESAR_noload_Minv", codegen_options);
  mecali::generate_code(C, "ASM_CAESAR_noload_C", codegen_options);
  mecali::generate_code(G, "ASM_CAESAR_noload_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "ASM_CAESAR_noload_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "ASM_CAESAR_noload_fk_ee", codegen_options);
  mecali::generate_code(fk, "ASM_CAESAR_noload_fk", codegen_options);
  mecali::generate_code(J_fd, "ASM_CAESAR_noload_J_fd", codegen_options);
  mecali::generate_code(J_id, "ASM_CAESAR_noload_J_id", codegen_options);

  robot_model.generate_json("ASM_CAESAR_noload.json");
