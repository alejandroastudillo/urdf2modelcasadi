...
int main()
{
    ...
    // ---------------------------------------------------------------------
      std::string urdf_filename = "../urdf2model/models/iiwa_description/urdf/iiwa14.urdf";
    ...
    // Print some information related to the imported model (boundaries, frames, DoF, etc)
      ...
      // // Set function for forward kinematics
        ...
        robot_model.generate_json("iiwa14.json");
      ...
      // Code-generate or save a function
        ...
        mecali::generate_code(fkpos_ee, "iiwa14_fkpos_ee", codegen_options);
        mecali::generate_code(fkrot_ee, "iiwa14_fkrot_ee", codegen_options);
        mecali::generate_code(fk_ee, "iiwa14_fk_ee", codegen_options);
        mecali::generate_code(fk, "iiwa14_fk", codegen_options);
        mecali::generate_code(fd, "iiwa14_fd", codegen_options);
        mecali::generate_code(id, "iiwa14_id", codegen_options);
}
