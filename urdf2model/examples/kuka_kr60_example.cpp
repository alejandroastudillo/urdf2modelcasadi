...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = "../urdf2model/models/kuka_kr60/urdf/kr60ha.urdf";
  ...
  casadi::Function fk_pos_ee = robot_model.forward_kinematics("position", "tool0");
  casadi::Function fk_rot_ee = robot_model.forward_kinematics("rotation", "tool0");
  ...
  robot_model.generate_json("kr60.json");
  ...
  mecali::generate_code(fd, "kr60_fd", codegen_options);
  mecali::generate_code(id, "kr60_id", codegen_options);
  mecali::generate_code(fk, "kr60_fk", codegen_options);
  mecali::generate_code(fk_ee, "kr60_fk_ee", codegen_options);
  mecali::generate_code(fk_pos_ee, "kr60_fkpos_ee", codegen_options);
  mecali::generate_code(fk_rot_ee, "kr60_fkrot_ee", codegen_options);

  mecali::generate_code(J_fd, "kr60_J_fd", codegen_options);
  mecali::generate_code(J_id, "kr60_J_id", codegen_options);
}
