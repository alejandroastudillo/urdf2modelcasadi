...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/mir250_m0609/mir250_m0609_ppr.urdf";
  ...
  std::vector<std::string> required_Frames = {"lin_x_joint", "lin_y_joint", "rot_z_joint", "joint1", "joint2", "joint3", "joint4", "joint5","joint6", "m0609_arm_flange_tool0"};
  ...
  mecali::generate_code(fd, "mir250_m0609_ppr_fd", codegen_options);
  mecali::generate_code(id, "mir250_m0609_ppr_id", codegen_options);
  mecali::generate_code(M, "mir250_m0609_ppr_M", codegen_options);
  mecali::generate_code(Minv, "mir250_m0609_ppr_Minv", codegen_options);
  mecali::generate_code(C, "mir250_m0609_ppr_C", codegen_options);
  mecali::generate_code(G, "mir250_m0609_ppr_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "mir250_m0609_ppr_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "mir250_m0609_ppr_fk_ee", codegen_options);
  mecali::generate_code(fk, "mir250_m0609_ppr_fk", codegen_options);
  mecali::generate_code(J_fd, "mir250_m0609_ppr_J_fd", codegen_options);
  mecali::generate_code(J_id, "mir250_m0609_ppr_J_id", codegen_options);

  robot_model.generate_json("mir250_m0609_ppr.json");
