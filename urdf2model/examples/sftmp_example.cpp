...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/sftmp/sim_assm.urdf";
  ...
  std::vector<std::string> required_Frames = {"joint1", "joint2", "joint3", "joint4", "joint5", "joint6", "endeffector"};
  ...
  mecali::generate_code(fd, "sftmp_fd", codegen_options);
  mecali::generate_code(id, "sftmp_id", codegen_options);
  mecali::generate_code(G, "sftmp_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "sftmp_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "sftmp_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "sftmp_fk_ee", codegen_options);
  mecali::generate_code(fk, "sftmp_fk", codegen_options);
  mecali::generate_code(J_fd, "sftmp_J_fd", codegen_options);
  mecali::generate_code(J_id, "sftmp_J_id", codegen_options);

  robot_model.generate_json("sftmp.json");
