...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/softarm/softarm.urdf";
  ...
  std::vector<std::string> required_Frames = {"Joint1", "Joint2", "Joint3", "Joint4", "Joint5", "tcp"};
  ...
  mecali::generate_code(fd, "softarm_fd", codegen_options);
  mecali::generate_code(id, "softarm_id", codegen_options);
  mecali::generate_code(M, "softarm_M", codegen_options);
  mecali::generate_code(Minv, "softarm_Minv", codegen_options);
  mecali::generate_code(C, "softarm_C", codegen_options);
  mecali::generate_code(G, "softarm_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "softarm_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "softarm_fk_ee", codegen_options);
  mecali::generate_code(fk, "softarm_fk", codegen_options);
  mecali::generate_code(J_fd, "softarm_J_fd", codegen_options);
  mecali::generate_code(J_id, "softarm_J_id", codegen_options);

  robot_model.generate_json("softarm.json");
