...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/softarm/softarm_prismatic.urdf";
  ...
  mecali::generate_code(fd, "softarm_prismatic_fd", codegen_options);
  mecali::generate_code(id, "softarm_prismatic_id", codegen_options);
  mecali::generate_code(M, "softarm_prismatic_M", codegen_options);
  mecali::generate_code(Minv, "softarm_prismatic_Minv", codegen_options);
  mecali::generate_code(C, "softarm_prismatic_C", codegen_options);
  mecali::generate_code(G, "softarm_prismatic_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "softarm_prismatic_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "softarm_prismatic_fk_ee", codegen_options);
  mecali::generate_code(fk, "softarm_prismatic_fk", codegen_options);
  mecali::generate_code(J_fd, "softarm_prismatic_J_fd", codegen_options);
  mecali::generate_code(J_id, "softarm_prismatic_J_id", codegen_options);

  robot_model.generate_json("softarm_prismatic.json");
