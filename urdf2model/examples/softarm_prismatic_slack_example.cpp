...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/softarm/softarm_prismatic_slack.urdf";
  ...
  std::vector<std::string> required_Frames = {"Joint1", "Joint2", "Joint3", "Joint4", "Joint5", "Joint6_R1", "Joint6_R2", "Joint6", "Joint7_R1", "Joint7_R2", "Joint7", "tcp"};
  ...
  mecali::generate_code(fd, "softarm_prismatic_slack_fd", codegen_options);
  mecali::generate_code(id, "softarm_prismatic_slack_id", codegen_options);
  mecali::generate_code(M, "softarm_prismatic_slack_M", codegen_options);
  mecali::generate_code(Minv, "softarm_prismatic_slack_Minv", codegen_options);
  mecali::generate_code(C, "softarm_prismatic_slack_C", codegen_options);
  mecali::generate_code(G, "softarm_prismatic_slack_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "softarm_prismatic_slack_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "softarm_prismatic_slack_fk_ee", codegen_options);
  mecali::generate_code(fk, "softarm_prismatic_slack_fk", codegen_options);
  mecali::generate_code(J_fd, "softarm_prismatic_slack_J_fd", codegen_options);
  mecali::generate_code(J_id, "softarm_prismatic_slack_J_id", codegen_options);

  robot_model.generate_json("softarm_prismatic_slack.json");
