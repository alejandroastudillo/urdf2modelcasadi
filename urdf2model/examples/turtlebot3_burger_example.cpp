...
int main()
{
  ...
  // ---------------------------------------------------------------------
  std::string urdf_filename = ws_path+"/urdf2model/models/turtlebot3/turtlebot3_burger.urdf";
  ...
  std::vector<std::string> required_Frames = {"lin_x_joint", "lin_y_joint", "rot_z_joint", "base_link"};

  std::string end_effector_name = "base_link";
  ...
  mecali::generate_code(fd, "turtlebot3_burger_fd", codegen_options);
  mecali::generate_code(id, "turtlebot3_burger_id", codegen_options);
  mecali::generate_code(M, "turtlebot3_burger_M", codegen_options);
  mecali::generate_code(Minv, "turtlebot3_burger_Minv", codegen_options);
  mecali::generate_code(C, "turtlebot3_burger_C", codegen_options);
  mecali::generate_code(G, "turtlebot3_burger_G", codegen_options);
  //mecali::generate_code(fk_ee_pos, "mmo500_ppr_fk_ee_pos", codegen_options);
   mecali::generate_code(fkrot_ee, "turtlebot3_burger_fkrot_ee", codegen_options);
  mecali::generate_code(fk_ee, "turtlebot3_burger_fk_ee", codegen_options);
  mecali::generate_code(fk, "turtlebot3_burger_fk", codegen_options);
  mecali::generate_code(J_fd, "turtlebot3_burger_J_fd", codegen_options);
  mecali::generate_code(J_id, "turtlebot3_burger_J_id", codegen_options);
  mecali::generate_code(J_s, "turtlebot3_burger_J_s", codegen_options);
  mecali::generate_code(J_b, "turtlebot3_burger_J_b", codegen_options);

  robot_model.generate_json("turtlebot3_burger.json");
