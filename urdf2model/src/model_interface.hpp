...
namespace mecali
{
  ...
  public:
    ...
    void import_floating_base_model(std::string filename, Eigen::Vector3d gravity_vector, bool joint_model_free_flyer, bool verbose);
    void import_planar_base_model(std::string filename, Eigen::Vector3d gravity_vector, bool joint_model_planar, bool verbose);
